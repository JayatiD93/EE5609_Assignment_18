...
& and $\lambda \in F$,then if $\vec{T}$ is a linear operator on a finite\\
& dimensional space $\vec{V}$, it must be $\vec{TB}=\lambda \vec{B}$ \\
& for all $\vec{B}$ where $\vec{B}$ is any $n \times n$ matrix in $\vec{V}$\\
& \\
& So, $(\vec{T}-\lambda\vec{I}) \vec{B}=\vec{0}$,$\implies \det{(\vec{T}-\lambda\vec{I})} =0$ \\
& \\
\hline
\multirow{3}{*}{} & \\
\textbf{Proof} & As per the problem statement, $\vec{TB}=\lambda \vec{B}$ \\
& \textbf{or,}  $\vec{AB} = \lambda \vec{B}$, as $\vec{TB} = \vec{AB}$\\
& \textbf{or,}  $\vec{(A-\lambda I)B} = \vec{0}$\\
& From here 2 cases can be arrived. \\
& \\
\hline
Case 1: & $\det{(\vec{(A-\lambda I)})} = 0$, where $\vec{B} \neq \vec{0}$\\
& $\implies$ $\lambda$ is characteristic value of $\vec{A}$.\\
& \\
\hline
Case 2: & $\det{(\vec{(A-\lambda I)})} \neq 0 $\\
& $\implies$ $\vec{(A-\lambda I)}$ is invertible and $\vec{B} = \vec{0}$\\
& so, for $\vec{(T-\lambda I)B} = \vec{0}$ and \\
& $\vec{(T-\lambda I)} \neq \vec{0}$\\
& $\implies \det{(\vec{T}-\lambda\vec{I})} \neq 0$\\
& which is a contradiction. So, case 2 is not\\
& possible.\\
\hline
Conclusion & So, from the above 2 cases and from \\
& the theorem,it can be concluded that $\vec{A}$ and \\
& $\vec{T}$ have the same  characteristic values\\
\hline
